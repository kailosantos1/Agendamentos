...
<div class="form-row">
    <div class="form-group col-md-6">
      ...
      <input type="text" class="form-control" id="titulo" name="titulo1" value="<?php echo $titulo?>" placeholder="Reunião...">
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="inputAddress" name="local_1" value="<?php echo $local?>" placeholder="Rua João Machado...">
  </div>
