...
.btn2{
 ...
 <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <form action="conectionc.php" method="post" >
  <div class="box">
       <fieldset>
    ...
    <div class="inputnome">  
      <input type="text" class="form-control" id="snome" placeholder="Sobrenome" name="snome">
      </div> 
 
    <input type="tel" class="form-control" name="phone1" id="phone" maxlength="17" placeholder="Telefone 01"/>
      

    <div class="telselec">
    <select id="exampleFormControlSelect1" class="form-control" name="selecttel"> 
    ...
    <input type="email" class="form-control"  placeholder="nome@exemple.com" name="email"> 
    </div>
   
   
    <input type="tel" class="form-control" name="phone2" id="phone" maxlength="17" placeholder="Telefone 02"/>  
    
   
    <div class="telselec">
    <select id="exampleFormControlSelect2" class="form-control" name="selecttel2"> 
